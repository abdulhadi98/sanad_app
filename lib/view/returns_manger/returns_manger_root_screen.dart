                  ...
                  child: Column(
                    children: [
                      ...
                      MainButton(
                        ...
                        onPressed: () {
                          Get.toNamed(
                            '/orders-quality-supervisor-screen',//here if you go to returns orders screen then all the orders will show in black color because the order will use the returns widget
                            arguments: {
                              "api": "/get-orders",
                            },
                          );
